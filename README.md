...
4. Set required env vars in Render:
   ...
   - `CORS_ORIGIN` = your frontend domain (for example `https://<your-vercel-app>.vercel.app`)
...
- Backend supports comma-separated origins in `CORS_ORIGIN` (example: `http://localhost:5173,https://<your-vercel-app>.vercel.app`).
